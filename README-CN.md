阿里云资源管理 Terraform 模块

# terraform-alicloud-resourcemanager

[English](https://github.com/alibabacloud-automation/terraform-alicloud-resourcemanager/blob/main/README.md) | 简体中文

用于在阿里云上创建资源管理服务资源的 Terraform 模块。此模块通过提供全面的资源管理组件集合（包括资源目录、文件夹、成员账号、资源组、策略和角色），帮助您建立企业级资源组织和管理能力。它为大规模云部署提供集中化治理、访问控制和资源组织功能。有关资源管理的更多信息，请参阅[资源管理](https://www.alibabacloud.com/help/en/resource-management/)。

## 使用方法

此模块提供灵活的资源创建控制，允许您只创建所需的资源或使用现有资源。以下是一个基本示例：
...
* [完整示例](https://github.com/alibabacloud-automation/terraform-alicloud-resourcemanager/tree/main/examples/complete)
